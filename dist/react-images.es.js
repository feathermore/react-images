...
function Header(_ref, _ref2) {
	...
	return React.createElement(
		...
		!!showRotateButton && React.createElement(
			'button',
			{
				title: rotateButtonTitle,
				className: css$1(classes.rotate),
				onClick: onRotate
			},
			React.createElement(Icon, { fill: !!theme$$1.rotate && theme$$1.rotate.fill || theme.rotate.fill, type: 'rotate' })
		),
